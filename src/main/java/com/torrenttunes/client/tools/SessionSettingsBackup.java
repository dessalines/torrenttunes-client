 ...
 * to {@link Session#setSettings(SessionSettingsBackup)} to change the settings,
 ...
 * @author aldenml
 */
public final class SessionSettingsBackup {

    private final session_settings s;

    public SessionSettingsBackup(session_settings s) {
        this.s = s;
    }
     ...
     * @return
     */
    public static SessionSettingsBackup newDefaults() {
        return new SessionSettingsBackup(new session_settings());
    }
     ...
     * @return
     */
    public static SessionSettingsBackup newMinMemoryUsage() {
        return new SessionSettingsBackup(libtorrent.min_memory_usage());
    }

    public static SessionSettingsBackup newHighPerformanceSeed() {
        return new SessionSettingsBackup(libtorrent.high_performance_seed());
    }
